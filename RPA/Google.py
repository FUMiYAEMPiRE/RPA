...
class Spreadsheet(object):
    def __init__(self):
        ...
        self.spreadsheet = build('sheets', 'v4', credentials=creds).spreadsheets()
    ...
    def　Get_values(self, Spreadsheet_id:str, Range:str):
        result = self.spreadsheet.values().get(spreadsheetId=Spreadsheet_id, range=Range).execute()
    ...
    def Get_sheets(self, Spreadsheet_id:str):
        sheet_metadata = self.spreadsheet.get(spreadsheetId=Spreadsheet_id).execute()
